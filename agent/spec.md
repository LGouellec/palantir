...
- Only take a new trade (entry or scale-in) while NYSE/NASDAQ is open. If the market is closed, log the incoming signal and ignore it - closing an existing position (SELL while long, BUY covering a short) still goes through regardless of market hours
